...
// //await is using inside the async functions
// function api(){
//     return new Promise((resolve,reject) => {
//         setTimeout( () => {
...
//this is the simpler in syntax
//but having the problem that we have to make another function and inside it we make await so double double kaam karne pad rhe hai isme humhe
//we use IIFE is a function
//the next and the simple version of the above code
(async function () {
    console.log("getting data1...");
    await getData(1);
    console.log("getting data2...");
